...
{                                                                                                                                                                                   
    ...
    // Rpp32f *batch_mean = (Rpp32f *)calloc(batch_size * sizeof(Rpp32f));
    // Rpp32f *batch_std_dev = (Rpp32f *)calloc(batch_size * sizeof());
    //cl_mem cl_batch_mean, cl_batch_std_dev;
    /*
        command queue, context and attach the mean and stadard deviations to that!
    */
    /*
